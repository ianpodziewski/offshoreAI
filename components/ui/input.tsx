  ...
  ({ className, type = "text", ...props }, ref) => {
    return (
      <input
        ...
        ref={ref}
        className={cn(
          // Added `text-left` below
          "flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-left placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      />
